...
### Please save October 26th and 27th, 2021
[![](files/images/CitSciSummitWide.jpg)](https://www.eventbrite.com/e/pnw-citizen-science-summit-tickets-167104687619)

The event will be hosted virtually on Zoom. Join us for two days of learning and networking.  
...
```{r echo=FALSE}
kable(ProjectList) %>% kable_styling(c("striped", "hover", "condensed", "responsive", font_size = 5,fixed_thead=TRUE)) %>% column_spec(1, bold = T,border_right = T, width_min="11em") %>% column_spec(3, width_min="12em")  %>% column_spec(4, width_min="14em") %>% scroll_box(width = "95%") 
```
/
