...
```{r echo=FALSE}
kable(ProjectList) %>% kable_styling(c("striped", "hover", "condensed", "responsive", font_size = 5)) %>% column_spec(1, bold = T,border_right = T, width_min="15em") %>% column_spec(4, width_min="20em")  %>% scroll_box(width = "95%", height = "700px")
```
