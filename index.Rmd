...
```{r echo=FALSE}
kable(ProjectList) %>% kable_styling(c("striped", "hover", "condensed", "responsive", font_size = 5,fixed_thead=TRUE)) %>% column_spec(1, bold = T,border_right = T, width_min="13em") %>% column_spec(3, width_min="12em")  %>% column_spec(4, width_min="16em") %>% scroll_box(width = "95%") 
```
